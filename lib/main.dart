            ...
            Row(
              ...
              children: [
                Container(
                  ...
                  width: 380,
                  child: Text(
                      'Seja bem-vindo ao meu “mini-mundo”. Fiz esse app com o intuito de estudar, mas também me apresentar!',
                      style: TextStyle(
                        color: Color.fromRGBO(75, 68, 69, 15),
                        fontWeight: FontWeight.bold,
                        fontFamily: 'Quicksand',
...
showAlertDialog(BuildContext context) {
  Widget dismissButton = TextButton(
    child: Text("Voltar", style: TextStyle(color: Colors.blueAccent, fontWeight: FontWeight.bold, fontSize: 14,),),
    onPressed: () {
                ...
                children: [
                  Flexible(
                    child: Text(
                      ...
                      textAlign: TextAlign.center, style: TextStyle(fontWeight: FontWeight.bold, fontSize: 14, color: Color.fromRGBO(99, 93, 94, 2)),
                    ),
                  )
                ],
              )
